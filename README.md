...
- [ ] We would like you to integrate with another service provider. It can be any TodoEntity
  service (e.g., Microsoft TodoEntity APIs), or you can also use a mock provider. Todos should be kept in sync between
  our service and the third-party integration.
